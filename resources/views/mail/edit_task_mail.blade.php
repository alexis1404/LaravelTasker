        ...
        <tr>
            <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td class="mainCells">
                            <p align="center">Your task was edited!</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 20px 0 30px 0;">
                            <p>Current task name: <span class="data-span">{{$task->name}}</span></p>
                            <p>Current task description: <span class="data-span">{{$task->description}}</span></p>
                            <p>Current task status: <span class="data-span">{{$task_status}}</span></p>
                        </td>
                    </tr>
                </table>
            </td>
